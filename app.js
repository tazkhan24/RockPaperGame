...
function lose(userChoice, computerChoice) {
	...
	const smallcompword = "comp".fontsize(3).sub();
	const userChoice_div = document.getElementById(userChoice);
	result_p.innerHTML = `${convertToWord(userChoice)} ${smalluserword}  loses to  ${convertToWord(computerChoice)}
...
function draw(userChoice, computerChoice) {
	...
	const smallcompword = "comp".fontsize(3).sub();
	const userChoice_div = document.getElementById(userChoice);
	result_p.innerHTML = `${convertToWord(userChoice)} ${smalluserword}  equals ${convertToWord(computerChoice)}
